...
import 'package:fluttermessenger/core/models/message_chat.dart';
import 'package:fluttermessenger/core/providers/auth_provider.dart';
import 'package:fluttermessenger/core/providers/chat_provider.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  bool isLastMessageLeft(int index) {
    if ((index > 0 &&
            listMessage[index - 1].get(FirestoreConstants.idFrom) == currentUserId) ||
        index == 0) {
      return true;
    } else {
      return false;
