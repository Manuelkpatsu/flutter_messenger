...
import 'package:fluttermessenger/constants/firestore_constants.dart';
import 'package:fluttermessenger/core/models/popup_choices.dart';
import 'package:fluttermessenger/core/models/user_chat.dart';
import 'package:fluttermessenger/core/providers/auth_provider.dart';
import 'package:fluttermessenger/core/providers/home_provider.dart';
import 'package:fluttermessenger/utils/debouncer.dart';
import 'package:fluttermessenger/utils/utilities.dart';
import 'package:fluttermessenger/view/widgets/loading_view.dart';
...
class _HomeScreenState extends State<HomeScreen> {
    ...
    firebaseMessaging.getToken().then((token) {
      ...
      if (token != null) {
        homeProvider.updateDataFirestore(
            FirestoreConstants.pathUserCollection, currentUserId, {'pushToken': token});
      }
    }).catchError((err) {
  ...
  void showNotification(RemoteNotification remoteNotification) async {
    AndroidNotificationDetails androidPlatformChannelSpecifics =
      ...
      Platform.isAndroid
          ? 'productapp.com.fluttermessenger'
          : 'productapp.com.fluttermessenger',
      'Flutter chat demo',
